...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/white-disk-e44b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/white-disk-e44b
```

A live public deployment of this template is available at [https://white-disk-e44b.templates.workers.dev](https://white-disk-e44b.templates.workers.dev)
